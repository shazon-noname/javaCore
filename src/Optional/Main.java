...
//        src.Optional<Computer> computerOptional = src.Optional.of(computer);
//
...
//        }
//
//        src.Optional<Computer> computerOptionalEmpty = src.Optional.empty();
//        Computer computer2 = computerOptionalEmpty.orElse(new Computer(new SoundCard(new USB("3.0"))));
//
//        // Оновлюємо src.Optional для другого комп'ютера
//        computerOptionalEmpty = src.Optional.of(computer2);
//
...
//        src.Optional<String> optionalString = src.Optional.empty();
