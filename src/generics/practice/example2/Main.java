package src.generics.practice.example2;

import src.generics.practice.example2.NotifactionDelivery.CourierDelivery;
import src.generics.practice.example2.NotifactionDelivery.DigitalDelivery;
import src.generics.practice.example2.NotifactionDelivery.PostalDelivery;
import src.generics.practice.example2.NotifactionDeliverySender.CourierDeliveryService;
import src.generics.practice.example2.NotifactionDeliverySender.DigitalDeliveryService;
import src.generics.practice.example2.NotifactionDeliverySender.PostalDeliveryService;
